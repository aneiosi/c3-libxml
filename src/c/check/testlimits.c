...
static void* hugeOpen(const char* URI) {
	...
	for (currentTest = 0; currentTest < sizeof(hugeTests) / sizeof(hugeTests[0]); currentTest++) {
 ...
 * @param ctxt  An XML parser context
 */
static void internalSubsetCallback(
 ...
 * @param ctxt  An XML parser context
 */
static void externalSubsetCallback(
	void* ctx                 ATTRIBUTE_UNUSED,
	const xmlChar* name       ATTRIBUTE_UNUSED,
	const xmlChar* ExternalID ATTRIBUTE_UNUSED,
	const xmlChar* SystemID   ATTRIBUTE_UNUSED
 ...
 */
static xmlParserInputPtr resolveEntityCallback(
	void* ctx               ATTRIBUTE_UNUSED,
 ...
 */
static xmlEntityPtr
getEntityCallback(void* ctx ATTRIBUTE_UNUSED, const xmlChar* name ATTRIBUTE_UNUSED) {
	callbacks++;
	return (NULL);
}
 ...
 */
static xmlEntityPtr
getParameterEntityCallback(void* ctx ATTRIBUTE_UNUSED, const xmlChar* name ATTRIBUTE_UNUSED) {
	callbacks++;
	return (NULL);
}
 ...
 */
static void entityDeclCallback(
	void* ctx               ATTRIBUTE_UNUSED,
	const xmlChar* name     ATTRIBUTE_UNUSED,
 ...
 */
static void attributeDeclCallback(
	void* ctx                   ATTRIBUTE_UNUSED,
 ...
 */
static void elementDeclCallback(
	void* ctx                    ATTRIBUTE_UNUSED,
	const xmlChar* name          ATTRIBUTE_UNUSED,
	int type                     ATTRIBUTE_UNUSED,
 ...
 * @param systemId  The system ID of the entity
 */
static void notationDeclCallback(
	void* ctx               ATTRIBUTE_UNUSED,
	const xmlChar* name     ATTRIBUTE_UNUSED,
	const xmlChar* publicId ATTRIBUTE_UNUSED,
	const xmlChar* systemId ATTRIBUTE_UNUSED
 ...
 */
static void unparsedEntityDeclCallback(
	void* ctx                   ATTRIBUTE_UNUSED,
	const xmlChar* name         ATTRIBUTE_UNUSED,
	const xmlChar* publicId     ATTRIBUTE_UNUSED,
	const xmlChar* systemId     ATTRIBUTE_UNUSED,
 ...
 */
static void
setDocumentLocatorCallback(void* ctx ATTRIBUTE_UNUSED, xmlSAXLocatorPtr loc ATTRIBUTE_UNUSED) {
	callbacks++;
}
 ...
 * @param ctxt  An XML parser context
 */
static void startDocumentCallback(void* ctx ATTRIBUTE_UNUSED) {
	callbacks++;
}
 ...
 * @param ctxt  An XML parser context
 */
static void endDocumentCallback(void* ctx ATTRIBUTE_UNUSED) {
	callbacks++;
}
 ...
 * @param name  The entity name
 */
static void referenceCallback(void* ctx ATTRIBUTE_UNUSED, const xmlChar* name ATTRIBUTE_UNUSED) {
	callbacks++;
}
 ...
 * @param len  the number of xmlChar
 */
static void ignorableWhitespaceCallback(
	void* ctx ATTRIBUTE_UNUSED, const xmlChar* ch ATTRIBUTE_UNUSED, int len ATTRIBUTE_UNUSED
) {
	callbacks++;
}
 ...
 * @param len  the number of xmlChar
 */
static void processingInstructionCallback(
	void* ctx             ATTRIBUTE_UNUSED,
...
static void cdataBlockCallback(
	void* ctx ATTRIBUTE_UNUSED, const xmlChar* value ATTRIBUTE_UNUSED, int len ATTRIBUTE_UNUSED
) {
	callbacks++;
}
 ...
 */
static void commentCallback(void* ctx ATTRIBUTE_UNUSED, const xmlChar* value ATTRIBUTE_UNUSED) {
	callbacks++;
}
 ...
 */
static void warningCallback(void* ctx ATTRIBUTE_UNUSED, const char* msg ATTRIBUTE_UNUSED, ...) {
	callbacks++;
}
 ...
 * @param ...  extra parameters for the message display
 */
static void errorCallback(void* ctx ATTRIBUTE_UNUSED, const char* msg ATTRIBUTE_UNUSED, ...) {
	callbacks++;
}
 ...
 * @param ...  extra parameters for the message display
 */
static void fatalErrorCallback(void* ctx ATTRIBUTE_UNUSED, const char* msg ATTRIBUTE_UNUSED, ...) {
}
 ...
 * @param name  The element name
 */
static void endElementNsCallback(
	void* ctx                ATTRIBUTE_UNUSED,
	const xmlChar* localname ATTRIBUTE_UNUSED,
	const xmlChar* prefix    ATTRIBUTE_UNUSED,
	const xmlChar* URI       ATTRIBUTE_UNUSED
 ...
 * @returns 0 in case of success, an error code otherwise
 */
static int readerTest(const char* filename, size_t limit, int options, int fail) {
...
typedef int              (*functest)(const char* filename, size_t limit, int options, int fail);
...
static int launchTests(testDescPtr tst, unsigned int test) {
	...
	for (i = 0; i < sizeof(limitDescriptions) / sizeof(limitDescriptions[0]); i++) {
		...
		res = tst->func(limitDescriptions[i].name, limit, limitDescriptions[i].options, fail);
		if (res != 0) {
			nb_errors++;
			err++;
		}
