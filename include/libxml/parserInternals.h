 ...
 */
#define IS_ASCII_LETTER(c)       ((0x61 <= ((c) | 0x20)) && (((c) | 0x20) <= 0x7a))
...
#define IS_PUBIDCHAR_CH(c)       xmlIsPubidChar_ch(c)
	...
	XMLPUBFUN void xmlCtxtErrMemory(xmlParserCtxt* ctxt);
	XMLPUBFUN int  xmlSwitchEncoding(xmlParserCtxt* ctxt, xmlCharEncoding enc);
	XMLPUBFUN int  xmlSwitchEncodingName(xmlParserCtxt* ctxt, const char* encoding);
	XMLPUBFUN int  xmlSwitchToEncoding(xmlParserCtxt* ctxt, xmlCharEncodingHandler* handler);
	XML_DEPRECATED
	XMLPUBFUN int xmlSwitchInputEncoding(
	...
	XML_DEPRECATED
	XMLPUBFUN int xmlPushInput(xmlParserCtxt* ctxt, xmlParserInput* input);
	XML_DEPRECATED
	XMLPUBFUN xmlChar         xmlPopInput(xmlParserCtxt* ctxt);
	XMLPUBFUN void            xmlFreeInputStream(xmlParserInput* input);
	 ...
	 */
	XML_DEPRECATED
	XMLPUBFUN const xmlChar* xmlParseName(xmlParserCtxt* ctxt);
	XML_DEPRECATED
	...
	XML_DEPRECATED
	XMLPUBFUN const xmlChar* xmlParseAttribute(xmlParserCtxt* ctxt, xmlChar** value);
	XML_DEPRECATED
	...
	XMLPUBFUN void xmlParseContent(xmlParserCtxt* ctxt);
	XML_DEPRECATED
	XMLPUBFUN void xmlParseElement(xmlParserCtxt* ctxt);
	XML_DEPRECATED
...
#define XML_SUBSTITUTE_BOTH  3
	/** @endcond */
	XML_DEPRECATED
	XMLPUBFUN xmlChar* xmlStringDecodeEntities(
		xmlParserCtxt* ctxt, const xmlChar* str, int what, xmlChar end, xmlChar end2, xmlChar end3
	);
	XML_DEPRECATED
	XMLPUBFUN xmlChar* xmlStringLenDecodeEntities(
		xmlParserCtxt* ctxt,
		const xmlChar* str,
		int            len,
		int            what,
	...
	XML_DEPRECATED
	XMLPUBFUN int xmlStringCurrentChar(xmlParserCtxt* ctxt, const xmlChar* cur, int* len);
	XML_DEPRECATED
	 ...
	 */
	XML_DEPRECATED
	XMLPUBFUN int xmlCurrentChar(xmlParserCtxt* ctxt, int* len);
	XML_DEPRECATED
