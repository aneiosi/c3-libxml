...
extern "C" {
	...
	XMLPUBFUN xmlEntity*         xmlNewEntity(
						xmlDoc*        doc,
						const xmlChar* name,
						int            type,
	...
	XMLPUBFUN xmlEntity* xmlAddDocEntity(
		xmlDoc*        doc,
		const xmlChar* name,
		int            type,
		const xmlChar* publicId,
	...
	XMLPUBFUN xmlEntity* xmlAddDtdEntity(
		xmlDoc*        doc,
		const xmlChar* name,
		int            type,
		const xmlChar* publicId,
	...
	XMLPUBFUN xmlEntity* xmlGetDocEntity(const xmlDoc* doc, const xmlChar* name);
