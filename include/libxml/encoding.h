...
#define isolat1ToUTF8 xmlIsolat1ToUTF8
	 ...
	 */
	typedef xmlCharEncError (*xmlCharEncConvFunc)(
	 ...
	 */
	typedef xmlParserErrors (*xmlCharEncConvImpl)(
		void* vctxt, const char* name, xmlCharEncFlags flags, xmlCharEncodingHandler** out
	);
	...
	xmlLookupCharEncodingHandler(xmlCharEncoding enc, xmlCharEncodingHandler** out);
	XMLPUBFUN xmlParserErrors
	xmlOpenCharEncodingHandler(const char* name, int output, xmlCharEncodingHandler** out);
	XMLPUBFUN xmlParserErrors xmlCreateCharEncodingHandler(
		const char*              name,
	...
	XMLPUBFUN xmlCharEncodingHandler* xmlFindCharEncodingHandler(const char* name);
	XML_DEPRECATED
	XMLPUBFUN xmlCharEncodingHandler* xmlNewCharEncodingHandler(
		const char* name, xmlCharEncodingInputFunc input, xmlCharEncodingOutputFunc output
	);
	XMLPUBFUN xmlParserErrors xmlCharEncNewCustomHandler(
		const char*              name,
	...
	struct _xmlBuffer;
	XMLPUBFUN int xmlCharEncOutFunc(
	...
	XML_DEPRECATED
	XMLPUBFUN int xmlCharEncFirstLine(
		xmlCharEncodingHandler* handler, struct _xmlBuffer* out, struct _xmlBuffer* in
	);
 ...
 */
	...
	XMLPUBFUN int
	xmlUTF8ToIsolat1(unsigned char* out, int* outlen, const unsigned char* in, int* inlen);
#endif /* LIBXML_OUTPUT_ENABLED */
	XMLPUBFUN int
	xmlIsolat1ToUTF8(unsigned char* out, int* outlen, const unsigned char* in, int* inlen);
#ifdef __cplusplus
}
#endif
