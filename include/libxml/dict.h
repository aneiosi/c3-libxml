...
extern "C" {
	 ...
	 */
	XMLPUBFUN xmlDict*       xmlDictCreate(void);
	...
	XMLPUBFUN void           xmlDictFree(xmlDict* dict);

	/*
	 * Lookup of entry in the dictionary.
	 */
	XMLPUBFUN const xmlChar* xmlDictLookup(xmlDict* dict, const xmlChar* name, int len);
