...
extern "C" {
	...
	XMLPUBFUN int
	xmlSchemaValidatePredefinedType(xmlSchemaType* type, const xmlChar* value, xmlSchemaVal** val);
	XMLPUBFUN int xmlSchemaValPredefTypeNode(
		xmlSchemaType* type, const xmlChar* value, xmlSchemaVal** val, xmlNode* node
	);
	XMLPUBFUN int xmlSchemaValidateFacet(
		xmlSchemaType* base, xmlSchemaFacet* facet, const xmlChar* value, xmlSchemaVal* val
	);
	XMLPUBFUN int xmlSchemaValidateFacetWhtsp(
	...
	XMLPUBFUN int             xmlSchemaCheckFacet(
								xmlSchemaFacet* facet, xmlSchemaType* typeDecl, xmlSchemaParserCtxt* ctxt, const xmlChar* name
							);
	...
	XMLPUBFUN int            xmlSchemaValidateListSimpleTypeFacet(
							 xmlSchemaFacet* facet,
							 const xmlChar*  value,
	...
	XMLPUBFUN int            xmlSchemaValidateLengthFacet(
							 xmlSchemaType*  type,
							 xmlSchemaFacet* facet,
							 const xmlChar*  value,
							 xmlSchemaVal*   val,
	...
	XMLPUBFUN int xmlSchemaValidateLengthFacetWhtsp(
		xmlSchemaFacet*              facet,
		xmlSchemaValType             valType,
		const xmlChar*               value,
		xmlSchemaVal*                val,
	...
	XMLPUBFUN int xmlSchemaValPredefTypeNodeNoNorm(
		xmlSchemaType* type, const xmlChar* value, xmlSchemaVal** val, xmlNode* node
	);
	XMLPUBFUN int xmlSchemaGetCanonValue(xmlSchemaVal* val, const xmlChar** retValue);
	XMLPUBFUN int xmlSchemaGetCanonValueWhtsp(
		xmlSchemaVal* val, const xmlChar** retValue, xmlSchemaWhitespaceValueType ws
	);
	...
	XMLPUBFUN xmlSchemaVal*
								xmlSchemaNewQNameValue(const xmlChar* namespaceName, const xmlChar* localName);
	XMLPUBFUN int xmlSchemaCompareValuesWhtsp(
		xmlSchemaVal*                x,
