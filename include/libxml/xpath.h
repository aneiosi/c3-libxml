...
extern "C" {
	 ...
	 */
	typedef xmlXPathObject* (*xmlXPathVariableLookupFunc)(
	...
	#define xmlXPathNodeSetItem(ns, index)                                                     \
		((((ns) != NULL) && ((index) >= 0) && ((index) < (ns)->nodeNr)) ? (ns)->nodeTab[(index)] \
		                                                                : NULL)
	/**
	...
	XMLPUBFUN void             xmlXPathFreeObject(xmlXPathObject* obj);
	...
	XMLPUBFUN int              xmlXPathCastNodeSetToBoolean(xmlNodeSet* ns);
	...
	XMLPUBFUN double           xmlXPathCastNodeToNumber(xmlNode* node);
	...
	XMLPUBFUN xmlChar*         xmlXPathCastNodeToString(xmlNode* node);
	...
	XMLPUBFUN void
	xmlXPathSetErrorHandler(xmlXPathContext* ctxt, xmlStructuredErrorFunc handler, void* context);
	...
	XMLPUBFUN int  xmlXPathSetContextNode(xmlNode* node, xmlXPathContext* ctx);
	...
	XMLPUBFUN xmlXPathCompExpr* xmlXPathCtxtCompile(xmlXPathContext* ctxt, const xmlChar* str);
	XMLPUBFUN xmlXPathObject*   xmlXPathCompiledEval(xmlXPathCompExpr* comp, xmlXPathContext* ctx);
	XMLPUBFUN int  xmlXPathCompiledEvalToBoolean(xmlXPathCompExpr* comp, xmlXPathContext* ctxt);
