...
extern "C" {
	 ...
	 *         method was found.
	 */
	typedef xmlParserInputBuffer* (*xmlParserInputBufferCreateFilenameFunc)(
	 ...
	 */
	XMLPUBFUN void                  xmlCleanupInputCallbacks(void);
	...
	XMLPUBFUN xmlParserInputBuffer* xmlParserInputBufferCreateIO(
	...
	XMLPUBFUN void  xmlFreeParserInputBuffer(xmlParserInputBuffer* in);
	XMLPUBFUN char* xmlParserGetDirectory(const char* filename);

	XMLPUBFUN int   xmlRegisterInputCallbacks(
	 ...
	 */
	XMLPUBFUN void             xmlCleanupOutputCallbacks(void);
	XMLPUBFUN int              xmlPopOutputCallbacks(void);
	XMLPUBFUN void             xmlRegisterDefaultOutputCallbacks(void);
	...
	XMLPUBFUN xmlOutputBuffer*
	xmlOutputBufferCreateBuffer(xmlBuffer* buffer, xmlCharEncodingHandler* encoder);

	XMLPUBFUN xmlOutputBuffer* xmlOutputBufferCreateFd(int fd, xmlCharEncodingHandler* encoder);

	XMLPUBFUN xmlOutputBuffer* xmlOutputBufferCreateIO(
	...
	XMLPUBFUN int            xmlOutputBufferWrite(xmlOutputBuffer* out, int len, const char* buf);
	XMLPUBFUN int            xmlOutputBufferWriteString(xmlOutputBuffer* out, const char* str);
	XMLPUBFUN int            xmlOutputBufferWriteEscape(
	...
	XMLPUBFUN int xmlOutputBufferClose(xmlOutputBuffer* out);

	XMLPUBFUN int xmlRegisterOutputCallbacks(
	...
	xmlNoNetExternalEntityLoader(const char* URL, const char* ID, xmlParserCtxt* ctxt);
